                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $totalEmpSQL = "SELECT * FROM ticket WHERE user_id='$user_id' AND solved ='true' ORDER BY id DESC";
                                                    ...
                                                    $empSQL = "SELECT * FROM ticket WHERE user_id='$user_id' AND solved ='true' ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
                                                ...
                                                <tr>                                                   
                                                    ...
                                                    <?php $status = $row['status'];if($status=='non-replyed'){ ?>
                                                    <td class="status">
                                                  ...
                                                  <?php } ?>
                                                    ...
                                                    <td class="status">
                                                        ...
                                                        <?php }else{?>
                                                            <p><a href="ticket-view.php?ticket_id=<?php echo $row['ticket_id'];?>">Closed</a></p>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                                <?php } ?>
