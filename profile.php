...
if(isset($_POST['save'])){
  ...
  $sql = "UPDATE user_info SET fname='$fname',lname='$lname',email='$email',country='$country',address='$address',city='$city',zip='$zip',birth='$birth',phone='$phone',facebook='$facebook',img='$file_name',time=$time WHERE id=$id";
  ...
  if($query){
    ...
    if(isset($_POST['save'])){
        ...
        $sql = "UPDATE user_info SET fname='$fname',lname='$lname',country='$country',address='$address',city='$city',zip='$zip',birth='$birth',phone='$phone',facebook='$facebook',img='$file_name',time=$time WHERE id=$id";
        $query = mysqli_query($conn,$sql);
        if($query){
          $msg = "Successfully Updated your Profile";
          header("location:profile.php?msg=$msg");
                    ...
                    <div class="dashboard_content">
                        <div class="dc_box">
                            ...
                            <div class="dc_box_container">
                                ...
                                <div class="flex_inputs">
                                    <div class="input_area">
                                        ...
                                        <select name="country" class="base_select">
                                            <option selected value="<?php echo $show['country'];?>">
                                                <?php echo $show['country'];?></option>
                                ...
                                <br />
                                <?php if(!empty($show['gmail_verify'])){?>
                                <div>
                                    ...
                                    <div class="base_input_icon">
                                        ...
                                        <input disabled name="email" type="text" value="<?php echo $show['email'];?>"
                                            id="facebook_profile" />
                                    </div>
                                </div>
                                <?php }else{?>
                                    ...
                                    <div class="base_input_icon">
                                        ...
                                        <input placeholder="Email" name="email" type="text" value="<?php echo $show['email'];?>"
                                            id="facebook_profile" />
                                    </div>
                                </div>
                             <?php } ?>
                                ...
                                <div>
                                    ...
                                    <div class="base_input_icon">
                                        ...
                                        <input name="facebook" type="text" value="<?php echo $show['facebook'];?>"
                                            id="facebook_profile" />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="base_input_icon">
                                        ...
                                        <input name="twitter" type="text" value="<?php echo $show['twitter'];?>"
                                            id="twitter_p" />
                                    </div>
                                </div>
                                ...
                                if(!$user['role']=='Admin'){ ?>
                                <input name="save" type="submit" class="base_btn" value="Save" />

                            <?php }else{ ?>
                                <input onclick="alert('Admin can not do it!')" type="submit" class="base_btn" value="Save" />
                            <?php } ?>
                            </div>
                            </form>
                        </div>
