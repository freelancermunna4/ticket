                            ...
                            <div class="dc_box_container">
                                <div class="table_wrapper">
                                    <div class="table" style="width: 100%">
                                        ...
                                        $sql = "SELECT * FROM user_info WHERE (id = '$src_text' OR fname = '$src_text' OR phone = '$src_text' OR nid_type = '$src_text' OR nid_number = '$src_text') AND nid_verify='Verified'";
                                        $search_query = mysqli_query($conn,$sql);
                                            ...
                                            $i = 0; while($row = mysqli_fetch_assoc($search_query)){$i++; ?>
                                               <tr>
                                                    <td><img style="width:40px;height:40px;border-radius:50px;" src="../upload/<?php echo $row['img'];?>" alt=""></td>
                                                    ...
                                                    <td class="t_action">
                                                        <p><a style="text-decoration:none;">Verified</a></p>
                                                        <!-- <p><a style="background:red;" href="ticket-delete.php?id=<?php echo $row['id'];?>">Delete</a></p> -->
                                                    </td>
                                                </tr>                                       
                                             <?php }}else{
                                                    ...
                                                    $totalEmpSQL = "SELECT * FROM user_info WHERE nid_verify='Verified' ORDER BY id DESC";
                                                    ...
                                                    $empSQL = "SELECT * FROM user_info WHERE nid_verify='Verified' ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
