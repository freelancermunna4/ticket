...
if(isset($_POST['save'])){
    ...
    if(empty($file_name)){
        $sql = "UPDATE website SET logo_text='$logo_text',f_text='$f_text',ticket_time='$ticket_time',facebook='$facebook',twitter='$twitter',youtube='$youtube',linkedin='$linkedin' WHERE id=1";
    }else{
                            ...
                            <div class="dc_box_container">
                                ...
                                <div class="flex_inputs">
                                    ...
                                    <div class="input_area">
                                        ...
                                        <input name="ticket_time" id="ticket_time" type="text" class="base_input"
                                            value="<?php echo $website['ticket_time'];?>" />
                                    </div>
                                </div>
                                <br>
                                <div class="flex_inputs">
                                <div class="input_area">
                                        ...
                                        <input name="facebook" id="l_name" type="text" class="base_input"
                                            value="<?php echo $website['facebook'];?>" />
                                    </div>
                                    <div class="input_area">
