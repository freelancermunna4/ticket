                            ...
                            <div class="dc_box_container">
                                <div class="table_wrapper">
                                    <div class="table" style="width: 100%">
                                        ...
                                        $sql = "SELECT * FROM ticket WHERE (user_id = '$src_text' OR user_name = '$src_text' OR ticket_id = '$src_text' OR status = '$src_text' OR phone = '$src_text' OR subject = '$src_text' OR option = '$src_text') AND refarence !='' AND solved ='' ";
                                        ...
                                        $i = 0; while($row = mysqli_fetch_assoc($search_query)){$i++; ?>
                                            ...
                                            <?php $status = $row['status'];if($status=='Pending'){ ?>
                                            <td class="status">
                                          ...
                                          <?php } ?>
                                                ...
                                                <td class="t_action">
                                                <p><a href="ticket-reply.php?user_id=<?php echo $row['id'];?>&&ticket_id=<?php echo $row['ticket_id'];?>">Reply</a>
                                                </p>
                                                
                                            <?php if($show['role']=='Moderator'){ ?>
                                                <p><a style="background:red;" href="#!">Delete</a>
                                                </p>
                                                <p><a href="#!">Solved</a>
                                                </p>
                                              <?php  }else{ ?>
                                                <p><a style="background:red;" href="ticket-delete.php?user_id=<?php echo $row['id'];?>&&ticket_id=<?php echo $row['ticket_id'];?>">Delete</a>
                                                </p>
                                                <p><a href="solving.php?id=<?php echo $row['id'];?>&&refarence=<?php echo $row['refarence'];?>">Solved</a>
                                                </p>
                                            <?php }?>
                                         </td>
                                        </tr>                                        
                                             <?php }}else{ 
                                                    ...
                                                    $totalEmpSQL = "SELECT * FROM ticket WHERE refarence !='' AND solved ='' ORDER BY id DESC";
                                                    ...
                                                    $empSQL = "SELECT * FROM ticket WHERE refarence !='' AND solved ='' ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
                                                  ...
                                                  <?php } ?>
                                                    ...
                                                    <?php if($show['role']=='Moderator'){ ?>
                                                        <p><a style="background:red;" onclick="alert('Moderator can not delete.')" href="#!">Delete</a>
                                                        </p>
                                                        <p><a onclick="alert('Moderator can not delete.')" href="#!">Solved</a>
                                                        </p>
                                                      <?php  }else{ ?>
                                                        <p><a style="background:red;" href="ticket-delete.php?user_id=<?php echo $row['id'];?>&&ticket_id=<?php echo $row['ticket_id'];?>">Delete</a>
                                                        </p>
